...
(function(root, factory) {
  ...
  Circles = function(element, options) {
  ...
  Circles.prototype = {
    ...
    _generateSvg: function() {
	  ...
	  this._fillPath = this._svg.getElementsByTagName('path')[0];
    ...
    {
    	this._textContainer.innerHTML =	value;
    	
    	return this;
    },
    
    updateValueStrokeClass: function(className)
    {
    	this._movingPath.classList = '';
      	this._movingPath.classList.add(className);
      	
      	return this;
    },
    
    updateMaxValueStrokeClass: function(className)
    {
    	this._fillPath.classList = '';
      	this._fillPath.classList.add(className);
  ...
  Circles.create = function(element, options) {
    return new Circles(element, options);
  };
