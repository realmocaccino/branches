    ...
    var $current,
      ...
      init = function(elSel) {
        ...
        $items.click(function() {
          ...
          if ($dropdown.hasClass('active') && !$li.hasClass('disabled') && !$li.hasClass('label') && $li.data('value')!==$selected.data('value')) {
            // Remove placeholder
            $items.filter('[data-placeholder="true"]').remove();
          ...
          if ($dropdown.hasClass('active')) {
            ...
            var nWinHeight = $dropdown.parents('#dialog').length ? $('#dialog').innerHeight() : window.innerHeight,
              nMaxHeight,
      ...
      renderItem = function(elOpt, sClass, bSelected) {
        ...
        if (elOpt) {
          ...
          if(elOpt.dataset.img) sImg = elOpt.dataset.img;
          if(elOpt.dataset.placeholder) isPlaceholder = true;
        ...
        return '<li id="item' + nTimestamp + '-' + nCount + '"'
          ...
          + 'px;line-height:' + (oOptions.height-4) + 'px;"' : '') + '>'
          + (sImg ? '<img src="' + sImg + '" />' : '')
          + sText
