{!! Form::text('name_pt', ['label' => 'Nome', 'placeholder' => 'Insira o nome da característica']) !!}

{!! Form::text('name_en', ['label' => 'Name', 'placeholder' => 'Enter the name of the characteristic']) !!}

{!! Form::text('name_es', ['label' => 'Nombre', 'placeholder' => 'Ingrese el nombre de la característica']) !!}

{!! Form::text('name_fr', ['label' => 'Nom', 'placeholder' => 'Entrez le nom de la caractéristique']) !!}
