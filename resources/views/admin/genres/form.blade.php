{!! Form::text('name_pt', ['label' => 'Nome', 'placeholder' => 'Insira o nome do gênero']) !!}

{!! Form::text('name_en', ['label' => 'Name', 'placeholder' => 'Enter the name of the genre']) !!}

{!! Form::text('name_es', ['label' => 'Nombre', 'placeholder' => 'Ingrese el nombre del género']) !!}

{!! Form::text('name_fr', ['label' => 'Nom', 'placeholder' => 'Entrez le nom du genre']) !!}
